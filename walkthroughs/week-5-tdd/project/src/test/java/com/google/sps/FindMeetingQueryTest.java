...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void everyAttendeeConsideredWithAllDayOptional() {
    Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.fromStartDuration(TIME_0800AM, DURATION_30_MINUTES),
            Arrays.asList(PERSON_A)),
        new Event("Event 2", TimeRange.fromStartDuration(TIME_0900AM, DURATION_30_MINUTES),
  ...
  public void NoMandatoryAttendeesWithGaps() {
      ...
      Collection<Event> events = Arrays.asList(
          new Event("Event 1", TimeRange.fromStartEnd(TimeRange.START_OF_DAY, TIME_0900AM, false), Arrays.asList(PERSON_A)),
          new Event("Event 2", TimeRange.fromStartEnd(TIME_1100AM, TIME_1150AM, false), Arrays.asList(PERSON_A)),
          new Event("Event 3", TimeRange.fromStartEnd(TIME_0930AM, TIME_1000AM, false), Arrays.asList(PERSON_B)));
  ...
  public void NoMandatoryAttendeesWithNoGaps() {
      Collection<Event> events = Arrays.asList(
          new Event("Event 1", TimeRange.fromStartEnd(TimeRange.START_OF_DAY, TIME_1100AM, false), Arrays.asList(PERSON_A)),
          new Event("Event 2", TimeRange.fromStartEnd(TIME_1100AM, TimeRange.END_OF_DAY, true), Arrays.asList(PERSON_A)),
      ...
      Collection<TimeRange> expected = Arrays.asList(
          ...
          TimeRange.fromStartEnd(TIME_1150AM, TimeRange.END_OF_DAY, true));
